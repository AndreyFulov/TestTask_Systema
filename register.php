...
if(!empty($_POST["login"]) && !empty( $_POST["password"])) {
    ...
    //Добавление пустой фотографии к новому пользователю
    $emptyPhotoPath = 'src/empty_photo.png';
    $photo = file_get_contents($emptyPhotoPath);
    $errorMessage = $database->CreateNewUser($login, $password, $emptyPhotoPath);
}
?>
